import binascii
import correo.charset
import correo.message
import correo.errors
from correo import quoprimime
...
def _prepare_set(msg, maintype, subtype, headers):
    ...
    if headers:
        ...
        except correo.errors.HeaderDefect as exc:
...
def set_text_content(msg, string, subtype="plain", charset='utf-8', cte=None,
    ...
    msg.set_param('charset',
                  correo.charset.ALIASES.get(charset, charset),
                  replace=True)
...
def set_message_content(msg, message, subtype="rfc822", cte=None,
    ...
    msg['Content-Transfer-Encoding'] = cte
    _finalize_set(msg, disposition, filename, cid, params)
raw_data_manager.add_set_handler(correo.message.Message, set_message_content)
