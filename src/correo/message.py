...
"""Basic message object for the correo package object model."""

__all__ = ['Message', 'correoMessage']
...
from correo import utils
from correo import errors
from correo._policybase import Policy, compat32
from correo import charset as _charset
from correo._encoded_words import decode_b
...
class Message:
    ...
    def as_string(self, unixfrom=False, maxheaderlen=0, policy=None):
        ...
        """
        from correo.generator import Generator
    ...
    def as_bytes(self, unixfrom=False, policy=None):
        ...
        """
        from correo.generator import BytesGenerator
        policy = self.policy if policy is None else policy
        fp = BytesIO()
    ...
    def get_payload(self, i=None, decode=False):
        ...
        is returned.
        """
        # Here is the logic table for this code, based on the correo5.0.0 code:
    ...
    def get_param(self, param, failobj=None, header='content-type',
        ...
        encoded, it can turn the return value into a string as follows:
            ...
            param = correo.utils.collapse_rfc2231_value(rawparam)
    ...
    # I.e. def walk(self): ...
    from correo.iterators import walk
...
class MIMEPart(Message):
    ...
    def __init__(self, policy=None):
        if policy is None:
            from correo.policy import default
            policy = default
