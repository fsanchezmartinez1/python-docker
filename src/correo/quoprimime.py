...
allowed in correo bodies or headers.

Quoted-printable is very space-inefficient for encoding binary files; use the
correo.base64mime module for that instead.
...
wrapping issues, use the correo.header module.
"""
...
def header_encode(header_bytes, charset='iso-8859-1'):
    ...
    used specifically for correo header fields to allow charsets with mostly 7
...
def header_decode(s):
    ...
    the high level correo.header class for that functionality.
    """
    s = s.replace('_', ' ')
