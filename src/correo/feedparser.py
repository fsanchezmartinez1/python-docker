...
"""FeedParser - An correo feed parser.

The feed parser implements an interface for incrementally parsing an correo
message, line by line.  This has advantages for certain applications, such as
those reading correo messages off a socket.
    ...
    def __init__(self, _factory=None, *, policy=compat32):
        ...
        if _factory is None:
            if policy.message_factory is None:
                from correo.message import Message
