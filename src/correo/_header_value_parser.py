"""Header value parser implementing various correo-related RFC parsing rules.

The parsing methods defined in this module implement various correo related
...
from correo import _encoded_words as _ew
...
def get_group_list(value):
    ...
    if value and value[0] in CFWS_LEADER:
        leader, value = get_cfws(value)
        if not value:
            # This should never happen in correo parsing, since CFWS-only is a
...
def get_address_list(value):
    ...
    address-list.  This is always true in correo parsing, and allows us
